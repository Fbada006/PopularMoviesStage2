...
public class MovieRepository {
    private MediatorLiveData<Resource<MovieResponse>> mMovieResource = new MediatorLiveData<>();
    private MediatorLiveData<Resource<MovieTrailerResponse>> mMovieTrailerResource = new MediatorLiveData<>();
    private MediatorLiveData<Resource<MovieReviewResponse>> mMovieReviewResource = new MediatorLiveData<>();
